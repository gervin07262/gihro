                ...
                <div class="tabs">
                    ...
                    <div class="tab-content">
                        <div class="list-items" class="tab-pane active">
                          {{ Form::open(['route' => 'panelDirectors.classrooms.store', 'method' => 'POST',
                              ...
                              <div class="wizard-tabs">
                                ...
                                <div class="tab-content">
                                  <div id="w1-account" class="tab-pane active">
                                    ...
                                    <div class="form-group">
                                      {{ Form::label('age_range_id','Rango de Edad', ['class' => 'col-sm-3 control-label']) }}
                                      <div class="col-sm-9">
                                        {{ Form::select('age_range_id',$ageRanges,null,['class' => 'form-control input-sm mb-md']) }}
                                      </div>
                                    </div>
                                    <div class="form-group">
                                      ...
                                      {{ Form::hidden('center_id', session('director_id') , []) }}
                                    </div>
                                  </div>
                              </div>
                          </div>
