...
<div id="modal-form-edit" class="modal-block modal-block-primary mfp-hide">
    <section class="panel">
        <header class="panel-heading">
                <h2 class="panel-title">Editar Niño</h2>
        </header>
        <div class="panel-body">
            <div id="msg-success" class="alert alert-success alert-dismissible" role="alert" style="display:none">
                ...
                <strong>Niño Modificado Correctamente.</strong>
            </div>
            ...
            {{ Form::open(['class' => 'form-horizontal mb-lg', 'id' => 'form-edit-kid']) }}
                @include('panel.directors.classroomkid.forms.editKid')
        ...
        <footer class="panel-footer">
            <div class="row">
                <div class="col-md-12 text-right">
                    {{ Form::button('Guardar', ['class' => 'btn btn-primary', 'id' => 'save-edit-kid']) }}
